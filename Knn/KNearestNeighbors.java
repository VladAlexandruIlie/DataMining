...
//        System.out.println(labelFrequency);
    ...
    public static void printAverageAccuracy(DataRepository answers, ArrayList<KNNData> knnData, int testSize, int kNeighbors, int iterations) {
        double accuracyTotal = 0;
        for (int i= 0; i< iterations; i++){
            ArrayList<KNNData> toTestData = new ArrayList<KNNData>(answers.getTestData(knnData, testSize));
            ArrayList<KNNData> trainingData = new ArrayList<KNNData>(answers.getTrainingData(knnData, toTestData));
